...
SDET Architectect Certification Exam, Our focus is to evaulaute hands on knowledge on Automation Testing and Java programming language.
...
Note: Base (BaseFame) framework is to help you get things faster - “if you want to”. However we realize, sometimes you may like to use your own tool set, in which case you are free to do so - with no marks deducted - so feel free to pickup whatever you like :).
